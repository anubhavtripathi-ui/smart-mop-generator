...
# ─── Template Path ───
TEMPLATE_PATH = os.path.join(os.path.dirname(__file__), "templates", "TM1.docx")
...
def check_template():
    if not os.path.exists(TEMPLATE_PATH):
        st.markdown("""
        <div class="error-box">
        ❌ <strong>Template Missing:</strong> templates/TM1.docx not found.<br>
        Please ensure TM1.docx is placed in the templates/ folder.
        </div>
        """, unsafe_allow_html=True)
        return False
    return True
...
# ─── Template Check ───
# Template check happens after selection below
        ...
        try:
            ...
            if result['success']:
                ...
                <div class="success-box">
                    ...
                    <p>📄 Output file: <strong>{output_filename}</strong></p>
                    <p>📎 Your original input is embedded as SOP attachment (proof of input)</p>
                    <p>🗑️ All uploaded data has been cleared from server memory</p>
                    <p>🔒 No data stored, logged, or retained on any server</p>
                    <br>
