...
def build_mop(
    ...
    # ── Remove borders from ALL tables in the template ────────────────────────
    # The cover table (containing "METHOD OF PROCEDURE") has visible borders
    # that render as dark lines around the title. Strip all table borders.
    ...
    for tbl in doc.tables:
        ...
        if tblPr is not None:
            ...
            if tblBdr is not None:
                tblPr.remove(tblBdr)
            # Also remove cell borders from all cells
